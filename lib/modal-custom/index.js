  ...
  return (
    <View>
      ...
      >
        <View style={[styles.container, modalBackgroundStyle]}>
          <View style={[styles.innerContainer, innerContainerTransparentStyle]}>
            <Text>
              This modal was presented {animated ? 'with' : 'without'}{' '}
              animation.
            </Text>
            <Button onPress={() => _setModalVisible(false)} style={styles.modalButton}>
              Close
            </Button>
          </View>
        </View>
      ...
      <View style={styles.row}>
        ...
        <SwitchIOS value={animated} onValueChange={_toggleAnimated} />
      </View>

      <View style={styles.row}>
        <Text style={styles.rowTitle}>Transparent</Text>
        <SwitchIOS value={transparent} onValueChange={_toggleTransparent} />
      </View>
